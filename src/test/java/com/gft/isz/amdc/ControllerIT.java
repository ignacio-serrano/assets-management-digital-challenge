...
public class ControllerIT {
	...
	private Map<String, Object> doPostAndAssertError(Shop shop, HttpStatus... anyOf) {
		ResponseEntity<Map<String, Object>> response = restTemplate.exchange("http://localhost:" + port + "/shops",
				HttpMethod.POST, new HttpEntity<Shop>(shop), new ParameterizedTypeReference<Map<String, Object>>() {
				});
